<section id="team" class="section bg-light-blue">
  <div class="container">
    ...
    <div class="speakers clearfix">
      <ul class="slick">
        <?php query_posts('showposts=3&post_type=team'); if (have_posts()) : ?> <?php while (have_posts()) : the_post(); ?>
        <li>    
          <a class="single-speaker wow fadeInUpSmall" data-wow-duration="600ms" data-wow-offset="10" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
            <div class="speaker-profile-img">
              <img class="grayscale" width="400" height="400" src="<?php the_post_thumbnail_url( 'square' ); ?>" alt="<?php the_field('your_name'); ?>" />
            </div>
      ...
      <?php else : ?>
      	<article id="post-not-found" class="hentry clearfix" style="text-align: center;">
      	   	<h1><?php _e( 'Oops, No Team Member found!' ); ?></h1>
      	</article>
      <?php endif; 
      wp_reset_query(); ?>	

    </div>
    <a class="more-btn center-aligned find-us" href="<?php echo home_url(); ?>/organizer-team">
      <span>See all Organizer Team</span>
