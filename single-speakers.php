        ...
        <div class="speaker-details flex flex-column">
          ...
          <div class="speaker-links">
            ...
            <?php $value = get_field( "your_website" );
              if( $value ) { ?>
                  <a class="website-link" href="<?php the_field('your_website'); ?>" target="_blank">
            ...
            <?php $value = get_field( "your_twitter" );
              if( $value ) { ?>
                  <a href="https://twitter.com/<?php the_field('your_twitter'); ?>" target="_blank">
            ...
            <?php $value = get_field( "your_instagram" );
              if( $value ) { ?>
                  <a href="https://www.instagram.com/<?php the_field('your_instagram'); ?>" target="_blank">
